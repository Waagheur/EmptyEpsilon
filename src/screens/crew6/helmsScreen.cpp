...
: GuiOverlay(owner, "HELMS_SCREEN", colorConfig.background)
{
    ...
    (new GuiDockingButton(this, "DOCKING", my_spaceship))->setPosition(20, -20, sp::Alignment::BottomLeft)->setSize(280, 50);

    (new GuiCustomShipFunctions(this, helmsOfficer, "", my_spaceship))->setPosition(-20, 120, sp::Alignment::TopRight)->setSize(250, GuiElement::GuiSizeMax);
}
