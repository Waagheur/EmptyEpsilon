...
: filename(filename)
{
    ...
    (new GuiLabel(this, "MAIN_LABEL", "Calibration ecran", 50))->setPosition(0, 100, sp::Alignment::TopCenter)->setSize(0, 300);
    ...
    ready_button = new GuiButton(this, "READY_BUTTON", "Fini", [this]() {
        destroy();
        returnToMainMenu();
    });
