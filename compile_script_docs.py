...
"""
        ...
        stream.write('<li><a name="enum_ESystem">ESystem</a>: "reactor", "beamweapons", "missilesystem", "maneuver", "impulse", "warp", "jumpdrive", "frontshield", "rearshield", "docks", "drones", "hangar"</li>\n')
        stream.write("<!--\n")
